...
<NamedLayer>
    <Name>GBR-features</Name>
    <UserStyle>
      <Name>GBR-features</Name>
      <Title>GBR features (mainland, reefs, islands)</Title>
      <Abstract>Shows all of the features in this dataset.</Abstract>
      <!-- ================ POLYGONS ================== -->
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#fbed8b</CssParameter>
              <CssParameter name="fill-opacity">0.3</CssParameter>
            </Fill>
            <Stroke>
<!--              <CssParameter name="stroke">#095f82</CssParameter> -->
              <CssParameter name="stroke">#897905</CssParameter>
